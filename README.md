...
- Short-term: Master the mathematical underpinnings of Deep Learning (Calculus, Linear Algebra, Probability) and become proficient in PyTorch.
- Mid-term: Contribute to open-source ML libraries and publish research in Computer Vision or NLP.
- Long-term: Build end-to-end intelligent systems that are scalable, ethical, and impactful.

> "I am still learning, exploring, and breaking things. This profile documents my journey from code to cognition."

---

## 🌱 Current Learning Focus

- Deep Learning: Re-implementing papers from scratch to understand architecture nuances.
- Mathematics: Optimization algorithms and statistical learning theory.
- Frameworks: Moving from "using" libraries to "understanding" their internals (PyTorch focus).
...
**Model Deployment, Backend & Cloud**
...
![Azure Machine Learning](https://img.shields.io/badge/Azure_ML-0078D4?style=flat-square&logo=microsoftazure&logoColor=white)
![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white)
![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)
